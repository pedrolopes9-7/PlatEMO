function Offspring = GA(Parent,Parameter,Memory)
...
%--------------------------------------------------------------------------
    ...
    maximumSizeCollision = EvaluateMemory(Memory);
    
    if (maximumSizeCollision >= 10)
        %adapt crossover and mutation probabilities
